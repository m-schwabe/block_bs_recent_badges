...
$params = array('aboutlink' => html_writer::link('https://moodle.org/plugins/block_bs_recent_badges', get_string('plugindirectory', 'block_bs_recent_badges'), array('target' => '_blank')),
